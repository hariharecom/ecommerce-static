      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Let's get you onboarded on JioMart. Contact HariHar E-com Services today to start your journey.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">ecomharihar@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91-9179022070</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-700">Official JioMart partner</span>
                </li>
                <li className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                ...
                <li className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-blue-600 rounded-full"></div>
                  <span className="text-gray-700">Future expansion ready</span>
                </li>
              </ul>
            </div>
          </div>
